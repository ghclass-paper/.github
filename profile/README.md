...
- [midterm1_ghclass-alice](https://github.com/ghclass-paper/midterm1_ghclass-alice), [midterm1_ghclass-bob](https://github.com/ghclass-paper/midterm1_ghclass-bob), [midterm1_ghclass-carol](https://github.com/ghclass-paper/midterm1_ghclass-carol), [midterm1_ghclass-dave](https://github.com/ghclass-paper/midterm1_ghclass-dave), [midterm1_ghclass-elizabeth](https://github.com/ghclass-paper/midterm1_ghclass-elizabeth), and [midterm1_ghclass-fred](https://github.com/ghclass-paper/midterm1_ghclass-fred) are the six individual repositories distributed from the midterm1 template.
...
One important way this demo differs from a real course is visibility. In an actual course, the instructor repository and every student repository are always private. We usually make the assignment templates private as well, although that is an instructor choice rather than a requirement. Everything here is public by design so that the organization can serve as a reference. See the [instructor repository](https://github.com/ghclass-paper/instructor) for details on how the organization was built and how to adapt the workflow to a course of your own.
